...
const deliveryAgentSchema = new Schema<DeliveryAgent>(
  {
    ...
    currentStatus: { type: String, enum: ['AVAILABLE', 'ON_ROUTE'], default: 'AVAILABLE' },
  },
  { collection: 'delivery_agents' }
);

const DeliveryAgentModel = models.DeliveryAgent || model<DeliveryAgent>('DeliveryAgent', deliveryAgentSchema);
